...
Here is the updated Free Pascal version of libssh2.pas, based on the comparison with the libssh2_priv.h header file:
...
type  
  ...
  LIBSSH2_SEND_FUNC = function(fd: libssh2_socket_t;
                                const buffer;
                                length: size_t;
                                flags: Integer;
                                abstract: Pointer): ssize_t; cdecl;

  LIBSSH2_RECV_FUNC = function(fd: libssh2_socket_t;
                                buffer;
                                length: size_t;
                                flags: Integer;
                                abstract: Pointer): ssize_t; cdecl;
